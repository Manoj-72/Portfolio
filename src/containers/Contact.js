...
import StrImg from './images/str.jpg';
import ArrImg from './images/ar.jpg';
import AniImg from './images/ani.jpg';
import TamashaImg from './images/tamasha.jpg';
...
const Bottom = styled.div`
  ...
  background-image: url(${TamashaImg});
  border-radius: 4px;
  background-size: cover;
  height: auto;
  ...
  return (
    <Wrapper>
      <Container>
        <SubContainer>
          <TextContent>
            ...
            <a href="mailto:manojchinnasamy72@gmail.com">
              <p className="link email"> manojchinnasamy72@gmail.com </p>
            </a>
          </TextContent>
        </SubContainer>
        ...
        <InstaGridWrapper>
          <InstaLeftWrapper>
            <LeftText>
              ...
              <a
                href="https://instagram.com/mr_toretto_"
                target="_blank"
      ...
      <Footer>
        ...
        <div>
          <a
            href="https://github.com/Manoj-72"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/manoj-chinnasamy/"
            className="social-link"
            target="_blank"
            rel="noopener noreferrer"
          >
